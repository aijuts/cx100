...
//			overridePendingTransition(R.anim.zoom_enter_2, R.anim.push_right_out);
	...
	class AsyncTaskHelper extends AsyncTask<String, String, String>{
		...
		protected void onPostExecute(String result) {
			...
			try {
				...
				Toast.makeText(NoticeActivity.this, "出错啦", Toast.LENGTH_SHORT).show();
			}
		}
	...
	public void asyNotice() {
		switch (exceptionNo) {
		case -2:
			Toast.makeText(NoticeActivity.this, "访问服务器失败", Toast.LENGTH_SHORT).show();
			break;
		case -1:
			Toast.makeText(NoticeActivity.this, "获取内容失败", Toast.LENGTH_SHORT).show();
			break;
		case 1:
