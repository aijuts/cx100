...
public class UserCenterGvTitleAdapter extends BaseAdapter {
	
	private Context context;
	private List<Map<String, Object>> list;
	private LayoutInflater mInflater;
	
	public UserCenterGvTitleAdapter(Context context, List<Map<String, Object>> list) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			convertView = mInflater.inflate(R.layout.gridview_item_usercenter_title, null);
